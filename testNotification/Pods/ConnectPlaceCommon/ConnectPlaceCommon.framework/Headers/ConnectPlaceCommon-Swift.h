...
@protocol CameraPermissionDelegate <NSObject>
- (void)onCameraAccessGranted;
- (void)onCameraAccessDenied;
@end


SWIFT_CLASS("_TtC18ConnectPlaceCommon27AnyCameraPermissionDelegate")
@interface AnyCameraPermissionDelegate : NSObject <CameraPermissionDelegate>
- (void)onCameraAccessGranted;
- (void)onCameraAccessDenied;
...
@interface HerowAppStateDetector : NSObject <CPAppStateDelegate>
- (nonnull instancetype)init OBJC_DESIGNATED_INITIALIZER;
- (void)duplicateOnAppInForeground;
- (void)onAppInForeground;
- (void)onAppInBackground;
@end
...
SWIFT_PROTOCOL("_TtP18ConnectPlaceCommon13GenericHolder_")
...
@interface DataHolderUserDefaults (SWIFT_EXTENSION(ConnectPlaceCommon)) <GenericHolder>
@end
...
SWIFT_CLASS("_TtC18ConnectPlaceCommon12GlobalLogger")
...
@interface LocationHealthCheckManager : NSObject <CPAppStateDelegate>
- (nonnull instancetype)init OBJC_DESIGNATED_INITIALIZER;
- (void)onAppInForeground;
- (void)onAppInBackground;
@end
...
typedef SWIFT_ENUM(int16_t, MotionHealthCheckError, closed) {
...
@interface MotionHealthCheckManager (SWIFT_EXTENSION(ConnectPlaceCommon)) <CPAppStateDelegate>
- (void)onAppInBackground;
- (void)onAppInForeground;
@end
...
@interface PlaceBeacon : NSObject <HerowPlace>
@property (nonatomic, readonly, copy) NSString * _Nonnull description;
- (BOOL)liveEventEnable SWIFT_WARN_UNUSED_RESULT;
- (NSString * _Nonnull)getId SWIFT_WARN_UNUSED_RESULT;
- (nonnull instancetype)init SWIFT_UNAVAILABLE;
...
@protocol ProximityHealthCheckDelegate <NSObject>
...
SWIFT_PROTOCOL("_TtP18ConnectPlaceCommon13ResetDelegate_")
